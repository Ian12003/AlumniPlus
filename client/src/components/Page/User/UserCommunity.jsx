...
const UserCommunity = () => {
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
      {/* Sidebar */}
      <aside className="w-full md:w-64 bg-indigo-300 text-white p-5 flex flex-col">
        {/* Profile Header */}
        <div className="flex items-center space-x-3 border-b border-white/30 pb-4">
        ...
        <nav className="mt-6 flex-1">
          <ul className="space-y-3">
            ...
            <li>
              <Link to="/dashboard/userblog" className="flex items-center space-x-2 hover:text-indigo-900 transition">
                <img className="w-5" src={blog} alt="Blog" />
                <span>Blog</span>
              </Link>
            </li>
            <li>
              <Link to="/dashboard/usercommunity" className="flex items-center space-x-2 hover:text-indigo-900 transition">
                <img className="w-5" src={community} alt="Community" />
                <span>Communities</span>
              </Link>
            </li>
            <li>
              <Link to="/dashboard/userachievement" className="flex items-center space-x-2 hover:text-indigo-900 transition">
      ...
      <main className="flex-1 p-4 md:p-6 overflow-auto">
        ...
        <div className="mt-6 bg-white p-4 rounded shadow">
          <p className="text-gray-700">
            Welcome to the community section! Here you can explore or join various communities.
          </p>
        </div>
      </main>
    </div>
